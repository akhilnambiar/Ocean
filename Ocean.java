      ...
      for (int i=0; i<xDim; i++) {
          for (int j=0; j<yDim; j++) {
              if (oceanArray[i][j][0]==EMPTY){
                  ...
                  int checker = sharkCheck(i,j);
                  if (checker==0) {
                      nextOcean.addShark(i,j);
                  }
                  else if (checker==1) {
                      nextOcean.addShark(i,j);
                      nextOcean.oceanArray[i][j][1] = this.oceanArray[i][j][1]+1;
                  }
                  else {
                      nextOcean.oceanArray[i][j][0]=EMPTY;
                  }
 ...
 **/
    public int fishCheck (int x, int y) {
        ...
        for (int i=-1; i<2; i++) {
            for (int j=-1; j<2; j++) {
                if (x+i<0 && y+j<0) {
                    if (oceanArray[xDim-1][yDim-1][0]==SHARK) {
                        sharkNumber++;
                    }
                }
                else if (x+i<0) {
                    if (oceanArray[xDim-1][(y+j)%yDim][0]==SHARK) {
                        sharkNumber++;
                    }
                }
                else if (y+j<0) {
                    if (oceanArray[(x+i)%xDim][yDim-1][0]==SHARK) {
                        sharkNumber++;
                    }
                }
                else{
                    if (oceanArray[(x+i)%xDim][(y+j)%yDim][0]==SHARK) {
                        sharkNumber++;
                    }
                }
            }
...
**/
    ...
    public int emptyFishSpawn (int x, int y) {
        ...
        for (int i=-1; i<2; i++) {
            for (int j=-1; j<2; j++) {
                if (x+i<0 && y+j<0) {
                    ...
                    if (oceanArray[xDim-1][(y+j)%yDim][0]==FISH) {
                        fishNumber++;
                    }
                    if (oceanArray[xDim-1][(y+j)%yDim][0]==SHARK) {
                        sharkNumber++;
                    ...
                    if (oceanArray[(x+i)%xDim][yDim-1][0]==FISH) {
                        fishNumber++;
                    }
                    if (oceanArray[(x+i)%xDim][yDim-1][0]==SHARK) {
                        sharkNumber++;
                    ...
                    if (oceanArray[(x+i)%xDim][(y+j)%yDim][0]==FISH) {
                        fishNumber++;
                    }
                    if (oceanArray[(x+i)%xDim][(y+j)%yDim][0]==SHARK) {
                        sharkNumber++;
        ...
        if (fishNumber>1&&sharkNumber<2){
            return 1;
        }
        else if (fishNumber>1 && sharkNumber>1) {
            return 2;
        }
        else{
            return 0;
 ...
 */
    public int sharkCheck (int x, int y) {
        ...
        if (fishNumber>0) {
            ...
            if ((oceanArray[x][y][1]+1)>starveTime) {
                return 2;
            }
            return 1;
        }
